...
u[times < sim_time / 4.0] = 1.0
u[np.logical_and(times >= sim_time / 4.0, times < sim_time / 2.0)] = 0.0
u[np.logical_and(times >= sim_time / 2.0, times < 3.0 * sim_time / 4.0)] = -1.0
u[np.logical_and(times >= 3.0 * sim_time / 4.0, times < sim_time)] = 0.0
u[times >= sim_time] = 1.0

v[times < sim_time / 4.0] = 0.0
v[np.logical_and(times >= sim_time / 4.0, times < sim_time / 2.0)] = 1.0
v[np.logical_and(times >= sim_time / 2.0, times < 3.0 * sim_time / 4.0)] = 0.0
v[np.logical_and(times >= 3.0 * sim_time / 4.0, times < sim_time)] = -1.0
v[times >= sim_time] = 0.0
